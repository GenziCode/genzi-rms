...
export default function CreatePOModal({
  ...
  const { data: productsData, isLoading: productsLoading } = useQuery({
      ...
      if (!productSearch || productSearch.trim().length === 0) {
        ...
        if (
          ...
          const vendorProducts =
            allProducts.products?.filter((p: any) =>
    ...
    enabled:
      !!productSearch ||
      (productFilter === 'vendor' && !!vendorId && !!selectedVendor),
  });
  ...
  const validateForm = (): boolean => {
    ...
    if (Object.keys(newErrors).length > 0) {
      if (newErrors.vendorId || newErrors.storeId) {
        ...
        newErrors.items ||
        Object.keys(newErrors).some((k) => k.startsWith('items.'))
      ) {
        setActiveTab('items');
      }
      return false;
  ...
  const FieldLabel = ({
    ...
    <label
      className={`block text-sm font-medium mb-2 flex items-center gap-1 ${error ? 'text-red-600' : 'text-gray-700'}`}
    >
      {label}
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100">
                  Add products and details for your purchase order
                </p>
              </div>
            </div>
            <button
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-3">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1">
                        <h3 className="text-sm font-semibold text-blue-900 mb-0.5">
                          Purchase Order Information
                        </h3>
                        <p className="text-xs text-blue-700">
                          Fill in the vendor and store details. These fields are
                          required to create a purchase order.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-green-700">
                          Search and add products. You can add individually,
                          scan barcodes, or bulk import via CSV.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      {productFilter === 'vendor' &&
                        (!selectedVendor?.products ||
                          ...
                          <span className="text-xs text-yellow-600 flex items-center gap-1">
                            ...
                            No products assigned to this vendor. Showing all
                            products.
                          </span>
                        )}
                    </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            onClick={() =>
                              downloadCSVTemplate(
                                csvTemplates.purchaseOrderProducts
                              )
                            }
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-purple-700">
                          Review the totals and details before submitting the
                          purchase order.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-amber-700">
                          Add any additional notes or special instructions for
                          this purchase order.
                        </p>
                      </div>
                    </div>
