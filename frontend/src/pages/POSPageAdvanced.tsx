...
import AdvancedProductSearch from '@/components/pos/AdvancedProductSearch';
import AdvancedPaymentModal from '@/components/pos/AdvancedPaymentModal';
...
export default function POSPageAdvanced() {
  ...
  const [pendingCustomerHistory, setPendingCustomerHistory] = useState(false);
      ...
      <div className="bg-white border-b">
        <div className="px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-bold text-gray-900">Advanced Point of Sale</h1>
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => {
                  ...
                  setPendingCustomerHistory(true);
                  setShowCustomerModal(true);
                  toast('Select a customer to view history.', { icon: 'ℹ️' });
                }}
                className="btn-header"
              >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-96 bg-white border-l flex flex-col">
          <div className="p-4 border-b">
            ...
            {/* Inventory Alerts */}
            <InventoryAlerts isVisible={cart.length > 0} />
      ...
      {showCustomerModal && (
        <CustomerQuickAdd
          onClose={() => {
            ...
            setPendingCustomerHistory(false);
          }}
          onSelect={(c) => {
            setCustomer({
              _id: c._id,
