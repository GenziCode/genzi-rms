...
import { salesReportsService, type TopSellingProducts } from '@/services/salesReports.service';
import { formatCurrency } from '@/lib/utils';
import { api } from '@/lib/api';
import { toast } from 'sonner';

function BottomSellingProductsReport() {
  ...
  // Fetch bottom selling products
  const {
    data: reportData,
    isLoading,
    refetch,
  } = useQuery<TopSellingProducts>({
    queryKey: ['bottom-selling-products', startDate, endDate, storeId, limit, sortBy],
    queryFn: () =>
      salesReportsService.getBottomSellingProducts({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Bottom Selling Products</h1>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow p-6 text-white">
              ...
              <p className="text-sm opacity-90 mb-1">Bottom Products</p>
          ...
          <div className="bg-white rounded-lg shadow overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">
                Bottom Selling Products ({products.length})
              </h2>
            </div>
...
export default BottomSellingProductsReport;
