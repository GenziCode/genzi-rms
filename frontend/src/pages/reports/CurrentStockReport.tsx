...
import type { CurrentStockStatus } from '@/services/inventoryReports.service';
...
function CurrentStockReport() {
  ...
  const {
    ...
    isLoading,
    refetch,
  } = useQuery<CurrentStockStatus>({
    queryKey: ['current-stock', storeId, categoryId, lowStockOnly, outOfStockOnly],
    queryFn: () =>
      inventoryReportsService.getCurrentStockStatus({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Current Stock Status</h1>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow p-6 text-white">
              ...
              <p className="text-3xl font-bold">{summary.outOfStockCount}</p>
            </div>
